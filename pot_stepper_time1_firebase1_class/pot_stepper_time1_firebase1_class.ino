...
//                    Serial.println(stepPath);
                    ...
                    burners[burnerNumber].setModesIntervalsNode(Firebase.get(String("/aaa/") + String("Food_profile/") + food_name + String("/steps")));
...
//                        Serial.println(val);
                    ...
                    if(ignited){
                        burners[burnerNumber].initCooking(path);
